...
// all registers used.
// x86-64 registers
enum class BaseRegister { AX, BX, CX, DX, SI, DI, R8, R9, R10, R11, R12, R13, R14, R15,  XMM0, XMM1, XMM2, XMM3, XMM4, XMM5, XMM6, XMM7  };

[[nodiscard]] auto is_float_register(BaseRegister p_reg) -> bool;

inline const std::vector<BaseRegister> float_regs = {BaseRegister::XMM0, BaseRegister::XMM1,
                                                      BaseRegister::XMM2, BaseRegister::XMM3,
                                                      BaseRegister::XMM4, BaseRegister::XMM5,
                                                      BaseRegister::XMM6, BaseRegister::XMM7};
