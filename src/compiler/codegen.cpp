...
void generateASMForInstruction(const target::Instruction& is, Ctx& ctx) {
    ...
    if (std::holds_alternative<target::Mov>(is)) {
        ...
        ctx.AddInstruction("mov " + target::to_asm(dst) + ", " +
        ...
        ctx.AddInstruction("mov " + target::to_asm(dst) + ", " + sourcesizeString +
                           to_asm(load.src));
        ...
        ctx.AddInstruction("add " + target::to_asm(dst) + ", " +
        ...
        ctx.AddInstruction("sub " + target::to_asm(dst) + ", " +
        ...
        ctx.AddInstruction("cmp " + target::to_asm(left) + ", " +
                           target::to_asm(right));
        ...
        ctx.AddInstruction("movzx " + target::to_asm(dst) + ", al");
        ...
        ctx.AddInstruction("movsx " + target::to_asm(dst) + ", " +
                           target::to_asm(src));
    }
    else {
