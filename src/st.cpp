...
SelectionStatement::SelectionStatement(Expression cond, std::unique_ptr<CompoundStatement> then,
...
Statement::Statement(std::unique_ptr<ExpressionStatement> stmt) : stmt(std::move(stmt)) {}
Statement::Statement(std::unique_ptr<ReturnStatement> stmt) : stmt(std::move(stmt)) {}
Statement::Statement(std::unique_ptr<SelectionStatement> stmt) : stmt(std::move(stmt)) {}
